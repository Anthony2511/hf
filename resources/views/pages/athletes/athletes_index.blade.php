        ...
        <div class="home-athletes__container">
            ...
            <div class="home-athletes__bloc">
                ...
                <section class="home-athletes__infos">
                    <h4 class="home-athletes__infos-title">{{$athlete->firstname}}<span>{{$athlete->lastname}}</span></h4>
                    <span class="home-athletes__disciplines">1500m, 5000m</span>
                </section>
                <a href="{{url('athletes/' . $athlete->slug )}}"
                   class="home-athletes__link" title="Vers la page de l'athlète : {{$athlete->firstname}} {{$athlete->lastname}}"></a>
            </div>
            @endforeach
        </div>
    </div>

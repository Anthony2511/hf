    ...
    <section class="wrap">
        <div class="trainee-home__container">
            <div class="trainee-home__bloc">
                <h3 class="title title__white title__left-white" aria-level="3" role="heading">Nous organisons des stages</h3>
                <p class="trainee-home__text">
                    L'union athlétique Hautes-Fagnes organise des stages pour jeunes (BPM, 8 à
                    12 ans) pendant les vacances de printemps et d'été. Ces stages, d'une durée

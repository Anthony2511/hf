<div class="single-stage">
    <section class="single-stage__container wrap">
        <h2 aria-level="2" class="title title__blue title__center">{{$internship->title}}</h2>
        ...
        <section class="single-stage__infos">
            <h3 aria-level="3" class="title title__blue title__center title-size">Informations générales</h3>
